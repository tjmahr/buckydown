...
\usepackage{xcolor}
\usepackage{mdframed}
% \mdfsetup{skipabove=5pt,skipbelow=0pt}
...
\newenvironment{Shaded}{\begin{snugshade}\begin{singlespace}}{\end{singlespace}\end{snugshade}}
...
\newcommand{\CommentTok}[1]{\textcolor{gry2}{\textit{#1}}}
\newcommand{\PreprocessorTok}[1]{\textcolor{gry2}{\textit{#1}}}
\newcommand{\InformationTok}[1]{\textcolor{gry2}{\textbf{\textit{#1}}}}
\newcommand{\WarningTok}[1]{\textcolor{gry2}{\textbf{\textit{#1}}}}

\newcommand{\NormalTok}[1]{\textcolor{gry3}{{#1}}}
\newcommand{\FunctionTok}[1]{\textcolor{gry3}{#1}}
\newcommand{\VariableTok}[1]{\textcolor{gry3}{#1}}
\newcommand{\ConstantTok}[1]{\textcolor{gry3}{#1}}
\newcommand{\SpecialCharTok}[1]{\textcolor{gry3}{#1}}
...
%
% % done
% \newcommand{\NormalTok}[1]{\textcolor[rgb]{0.322,0.365,0.431}{{#1}}}
%
% \newcommand{\OtherTok}[1]{\textcolor{gren}{{#1}}}
% \newcommand{\KeywordTok}[1]{\textcolor{gren}{{#1}}}
% \newcommand{\OperatorTok}[1]{\textcolor{gren}{{#1}}}
% \newcommand{\BuiltInTok}[1]{\textcolor{gren}{{#1}}}
% \newcommand{\ControlFlowTok}[1]{\textcolor{gren}{{#1}}}
%
%
% \newcommand{\CommentTok}[1]{\textcolor{gry2}{\textit{{#1}}}}
